...
### Story J.m.6: Apply Quizazz Vendor-Pushback Recommendations to `consumer-dependency-spec.md` [Planned]
...
- [ ] **Add new RR-1b: Prop and Event Relabel** — insert as a new `#### RR-1b` H4 subsection immediately after RR-1a's content ends ([consumer-dependency-spec.md:140](quizazz/consumer-dependency-spec.md#L140), before `### RR-2`), parallel in spirit to RR-1a. Content must:
