...
- Name: navigation.spec.ts >> lesson navigation routing >> dashboard "Start module" deep-links into a lesson
- Location: e2e/navigation.spec.ts:24:2
...
Call log:
  - waiting for getByRole('button', { name: /start module|continue/i }).first()
